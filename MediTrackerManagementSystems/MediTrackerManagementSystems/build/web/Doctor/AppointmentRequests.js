...
$(document).ready(function () {
    alert("Came to AppointmentRequest JS");
...
//            request.send(null);
        ...
        $.ajax({
            url: 'http://localhost:8080/MediTrackerManagementSystems/ConfirmAppointmentServlet',
            dataType: "json",
            type: "POST",
            data: {
                ...
                $.each(data,
                        function () {
                            if (this.status == "Approve") {
                                $('#divAppointments').append("<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.appointmentID + "</div>"
                                        + "<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.patientName + "</div>"
                                        ...
                                        + "<div class=\"col-sm-2\" style=\"background-color:lavender\">" + "<u onClick = \"updateStatus(this)\">" + this.status + "</u>&nbsp &nbsp &nbsp<u>Reject</u>" + "</div>"
                                        );
                            } else {
                                $('#divAppointments').append("<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.appointmentID + "</div>"
                                        + "<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.patientName + "</div>"
