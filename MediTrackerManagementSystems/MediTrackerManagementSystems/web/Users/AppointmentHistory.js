                ...
                $.each(data,
                        function () {
                            $('#divAppointments').append("<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.appointmentID + "</div>"
                                    + "<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.doctorName + "</div>"
                                    + "<div class=\"col-sm-2\" style=\"background-color:lavender\">" + this.hospitalName + "</div>"
...
//                            );
    ...
    $("#makeAppointmentID").click(function () {
        //alert(emailID);
        window.location.href = "http://localhost:8080/MediTrackerManagementSystems/faces/Users/MakeAnAppointment.html?email=" + emailID.toString();
    });
});